...
export default {
    ...
    var data = {
      ...
      options: {
        ...
        customBackend: {
          ...
          "sub.zheng.ms (zheng.ms提供)": "https://sub.zheng.ms/sub?",
            ...
            options: [
              {
                label: "zheng 自定义版 ",
                value:
                  "https://raw.githubusercontent.com/w312112325/clash/main/celuo.list"
              },
              {
  ...
  mounted() {
    ...
    this.form.remoteConfig = "https://raw.githubusercontent.com/w312112325/clash/main/celuo.list";
